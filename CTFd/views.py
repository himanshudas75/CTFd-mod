...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
          <p>Welcome to Infosec CyberLabs</p>
            <p>Follow us on social media:</p>
            <a href="https://www.linkedin.com/company/cyberlabs-iitism/"><i class="fab fa-linkedin fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://www.instagram.com/cyberlabs_iitism/"><i class="fab fa-instagram fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://github.com/Cyber-Labs"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
